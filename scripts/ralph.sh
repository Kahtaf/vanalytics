...
# Ralph loop runner — Vanalytics
#
# Usage:
#   ./scripts/ralph.sh                             # use default prompt, unlimited
#   ./scripts/ralph.sh <prompt_file>               # custom prompt, unlimited
#   ./scripts/ralph.sh <prompt_file> 10            # custom prompt, max 10 iterations
#   ./scripts/ralph.sh 10                          # default prompt, max 10 iterations
#
# Notes:
# - Requires Claude Code CLI (`claude`) and `jq` installed.
...
# - Each iteration: pick next eligible task, implement, commit, exit. Repeat.
